...
def normalize_shared_link(entry: SharedLinkMetadata) -> dict[str, Any]:
    ...
    return {
        ...
        "visibility": _tag(permissions.resolved_visibility),
        "expires": _isoformat(entry.expires),
        "allow_download": permissions.allow_download,
        "effective_audience": _tag(permissions.effective_audience),
        "requested_visibility": _tag(permissions.requested_visibility),
        "access_level": _tag(permissions.link_access_level),
